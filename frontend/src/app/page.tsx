...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f8f9fd] text-[#1f2937]">
      {/* GIGW 3.0 Government of India Header */}
      <Header
        activeTab={activeTab}
      ...
      {/* Main Content Body */}
      <main className="flex-1 container mx-auto px-4 sm:px-8 py-6">
        {activeTab === "dashboard" && (
        ...
        {activeTab === "repository" && <NationalRepositoryView />}
      </main>
      ...
      <footer className="bg-[#081729] text-slate-400 text-xs py-6 border-t border-slate-800">
        <div className="container mx-auto px-4 sm:px-8 flex flex-wrap items-center justify-between gap-4">
          <div>
