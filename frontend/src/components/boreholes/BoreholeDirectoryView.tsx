    ...
    <div className="space-y-4">
      ...
      <div className="bg-white p-4 rounded-lg border border-[#d9e2ec] shadow-sm flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center space-x-2">
          <Layers className="w-5 h-5 text-[#0c2340]" />
      ...
      {selectedBorehole && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex justify-end">
          <div className="w-full max-w-2xl bg-white h-full overflow-y-auto shadow-2xl p-6 space-y-6 flex flex-col justify-between">
            ...
            {/* Drawer Footer */}
            <div className="border-t border-[#d9e2ec] pt-4 flex items-center justify-between">
              <span className="text-xs text-slate-500 font-mono">
                Dossier ID: CMPDI/NK-IV/{selectedBorehole.boreholeId}
              </span>
              <button
                onClick={() => setSelectedBorehole(null)}
                className="px-4 py-2 bg-[#0c2340] text-white text-xs font-semibold rounded-md hover:bg-[#081729]"
              >
                Close Dossier
              </button>
            </div>
