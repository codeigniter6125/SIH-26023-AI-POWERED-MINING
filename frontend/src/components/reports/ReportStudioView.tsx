        ...
        <div className="bg-white rounded-lg border border-[#d9e2ec] shadow-sm overflow-hidden">
          ...
          <div className="bg-[#0c2340] text-white p-5 flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-3">
              <button 
                onClick={() => alert("Statutory Form-V PDF exported.")}
                className="px-3 py-1.5 bg-white/10 hover:bg-white/20 text-white text-xs font-semibold rounded border border-white/20 flex items-center space-x-1.5 transition-colors"
              >
                <Download className="w-3.5 h-3.5" />
                <span>Export Form-V PDF</span>
              </button>
              <button 
                onClick={() => alert("Report Docket exported as Word (.docx).")}
                className="px-3 py-1.5 bg-amber-500 hover:bg-amber-600 text-slate-950 text-xs font-bold rounded flex items-center space-x-1.5 transition-colors"
              >
                <Download className="w-3.5 h-3.5" />
